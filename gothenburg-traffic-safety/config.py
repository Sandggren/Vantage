...
# Vantage logo files (see assets/). Absolute paths so they load no matter
# which folder the app is started from.
ASSETS_DIR = Path(__file__).resolve().parent / "assets"
LOGO_PATH = str(ASSETS_DIR / "vantage_logo.png")  # full logo, shield + name
LOGO_WIDE_PATH = str(ASSETS_DIR / "vantage_logo_wide.png")  # sidebar
LOGO_ICON_PATH = str(ASSETS_DIR / "vantage_icon.png")  # shield only: favicon, collapsed sidebar
...
# color + dashed outline -- purple always means demo data). Set this to
...
# User-submitted near-miss reports (Report Near Miss page), stored locally
# as CSV -- see near_miss.py.
NEAR_MISS_REPORTS_PATH = str(Path(__file__).resolve().parent / "data" / "near_miss_reports.csv")
