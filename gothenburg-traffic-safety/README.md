...
density to show a real trade-off. The fake ones are always visually
...
├── pages/
│   ├── 1_Report_Near_Miss.py    # placeholder
│   ├── 2_Route_Check.py         # fast vs. lower-risk route comparison
│   └── 3_Dashboard.py           # placeholder
├── data/
...
- [ ] Hotspot heatmap layer (alternative to individual incident markers)
- [ ] Vasttrafik bus/tram layer (GTFS, filtered to Gothenburg)
- [ ] Planner dashboard with filters and export
